<!-- src/routes/cities/+page.svelte  (translation-free) -->
<script lang="ts">
	import { onMount } from 'svelte';
	import HeroTopbar from '$lib/components/HeroTopbar.svelte';

	// Static copy (previously i18n)
	const headingTxt = 'Hotels & restaurants across tour cities';
	...
	// Make sure these image files exist in /static/cities/*
	const cities: City[] = [
		{
			name: 'London',
...
<style>
	...
	/* ——— Remove the extra “bubble” blur (common magnifier class names) ——— */
	:global(.magnifier),
